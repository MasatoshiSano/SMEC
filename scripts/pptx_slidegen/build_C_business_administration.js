...
// ---------- Slide 51: C-25 労働関連法規 ----------
{
  ...
  s.addText(
    "ここから扱う人的資源管理（採用・評価・育成等、C-26以降）の土台となるのが、企業が最低限守るべき労働関連法規。法律名と規制内容を正確に対応させることがまず必要になる。",
    { x: 0.55, y: 1.85, w: 12.25, h: 0.4, fontFace: F_BODY, fontSize: 10, color: INK_SOFT, isTextBox: true, margin: 0, lineSpacingMultiple: 1.25 }
  );
  addRowList(s, 0.55, 2.35, 12.25, [
...
// ---------- Slide 74: C-39 プライシング ----------
{
  ...
  s.addText(
    "4P（C-31）のうち「Price」を深掘りする論点。原価・顧客・競合のどれを起点に価格を決めるかで性格が変わり、心理面への配慮も価格設定の重要な要素になる。",
    { x: 0.55, y: 1.85, w: 12.25, h: 0.4, fontFace: F_BODY, fontSize: 10, color: INK_SOFT, isTextBox: true, margin: 0, lineSpacingMultiple: 1.25 }
  );
  addRowList(s, 0.55, 2.35, 12.25, [
...
// ---------- Slide 80: C-41 プロモーション ----------
{
  ...
  s.addText(
    "C-40のコミュニケーション手段をさらに深掘りし、人的販売・販売促進・PRという3つの実行手法と、消費者・流通のどちらに働きかけるか（プル／プッシュ）という戦略的な選択を整理する。",
    { x: 0.55, y: 1.85, w: 12.25, h: 0.45, fontFace: F_BODY, fontSize: 10, color: INK_SOFT, isTextBox: true, margin: 0, lineSpacingMultiple: 1.25 }
  );
  addRowList(s, 0.55, 2.4, 12.25, [
...
// ---------- Slide 81: C-42 流通チャネル ----------
{
  ...
  s.addText(
    "4P（C-31）の最後の要素「Place」にあたる論点。どれだけ多くの店に置くか（開放度）という伝統的な視点に加え、近年はネットと実店舗の垣根をなくす発想も重要になっている。",
    { x: 0.55, y: 1.85, w: 12.25, h: 0.4, fontFace: F_BODY, fontSize: 10, color: INK_SOFT, isTextBox: true, margin: 0, lineSpacingMultiple: 1.25 }
  );
  addRowList(s, 0.55, 2.35, 12.25, [
