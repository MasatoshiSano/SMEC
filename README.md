...
docs/textbook/
  ...
  slides/                       A科目・全36論点の図解＋教科書全文PowerPointスライド
```
...
- 図で全体像をつかむ場合は `docs/textbook/slides/` のPowerPointを使う。現在はA科目の全36論点を図解し、基本概念・表・公式・具体例・ひっかけポイント・過去問参照の全文も詳細スライドに収録している。
