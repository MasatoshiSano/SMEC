...
教科書は文章中心のため、スライド教材への展開を検討中。デザインの方向性（配色・構成ルール）は `docs/11_slide_template_spec.md` に確定済みで、`docs/slide_template/` にサンプル一式（図解主体：汎用パターン12種＋科目別専用グラフ21種／文章主体：T1〜T3の3種）がある。論点の性質に応じて図解主体・文章主体を使い分ける方針。まだデザイン検証の段階で、実際の教科書コンテンツを流し込んだ本番スライドはこれから。
