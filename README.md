...
docs/textbook/
  ...
  slides/                       SMEC標準図解テンプレート（汎用12＋経済学専用6パターン）と科目別PowerPointスライド
```
...
- 図で全体像をつかむ場合は `docs/textbook/slides/` のPowerPointを使う。汎用12＋経済学専用6パターンの標準テンプレートを基に、現在はA科目の全体マップ・8セクション要点をコンパクトな図解スライド（11枚）で整理している。
